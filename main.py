...
#Se crea ventana
   ...
   def ayuda():
      ...
      ayudatxt = tkinter.Label(canvaAyuda, text="Descripcion del juego", font=("Cooper black", 14), bg="lightYellow", fg="black")  # Ayuda
      ayudatxt.place(x=10, y=100)
      ayudatxt = tkinter.Label(canvaAyuda, text="El juego consiste en dos tableros de una medida de 10x10 en el cual cada jugador tiene 3 barcos", font=("Cooper black", 12), bg="lightYellow", fg="black")  # Ayuda
      ayudatxt.place(x=10, y=125)
      ayudatxt = tkinter.Label(canvaAyuda, text="y cada jugador tiene cierta cantidad de balas. Existen tres tipos de barcos: los antisubmarinos", font=("Cooper black", 12), bg="lightYellow", fg="black")  # Ayuda
      ayudatxt.place(x=10, y=150)
      ayudatxt = tkinter.Label(canvaAyuda, text="que abarcan 1 espacio en el tablero, los cruceros que abarcan 2 espacios y los destructores que", font=("Cooper black", 12), bg="lightYellow", fg="black")  # Ayuda
      ayudatxt.place(x=10, y=175)
      ayudatxt = tkinter.Label(canvaAyuda, text="abarcan 3 espacios. El objetivo es destruir los barcos de tu oponente antes de que el destruya los", font=("Cooper black", 12), bg="lightYellow", fg="black")  # Ayuda
      ayudatxt.place(x=10, y=200)
      ayudatxt = tkinter.Label(canvaAyuda, text="de uno.", font=("Cooper black", 12), bg="lightYellow", fg="black")  # Ayuda
      ayudatxt.place(x=10, y=225)
      ayudatxt = tkinter.Label(canvaAyuda, text="Instrucciones del juego", font=("Cooper black", 14), bg="lightYellow", fg="black")  # Ayuda
      ayudatxt.place(x=10, y=250)
      ayudatxt = tkinter.Label(canvaAyuda, text="1. Para comenzar cada jugador debera de ordenar los barcos en la ubicacion que uno desee, ya sea", font=("Cooper black", 12), bg="lightYellow", fg="black")  # Ayuda
      ayudatxt.place(x=10, y=275)
      ayudatxt = tkinter.Label(canvaAyuda, text="vertical u horizontal siempre y cuando mantengamos un espacio de por medio entre cada barco", font=("Cooper black", 12), bg="lightYellow", fg="black")  # Ayuda
      ayudatxt.place(x=10, y=300)
      ayudatxt = tkinter.Label(canvaAyuda, text="2. Luego de que ya tengamos los barcos posicionados comenzamos a jugar.", font=("Cooper Black", 12), bg="lightYellow", fg="black")  # Ayuda
      ayudatxt.place(x=10, y=325)
      ayudatxt = tkinter.Label(canvaAyuda, text="3. El jugador 1 debera decir unas coordenadas aleatorias y el jugador 2 debera de decirle al", font=("Cooper black", 12), bg="lightYellow", fg="black")  # Ayuda
      ayudatxt.place(x=10, y=350)
      ayudatxt = tkinter.Label(canvaAyuda, text="jugador 1 si el tiro acerto o fallo, en caso de que acertara el tiro el jugador 1 este ", font=("Cooper black", 12), bg="lightYellow", fg="black")  # Ayuda
      ayudatxt.place(x=10, y=375)
      ayudatxt = tkinter.Label(canvaAyuda, text="mantendra su turno, en caso de que falle el tiro el turno se le pasara al jugador 2.", font=("Cooper black", 12), bg="lightYellow", fg="black")  # Ayuda
      ayudatxt.place(x=10, y=400)
      ayudatxt = tkinter.Label(canvaAyuda, text="4. La partida terminara cuando uno de los dos jugadores pierda sus tres embarcaciones.", font=("Cooper black", 12), bg="lightYellow", fg="black")  # Ayuda
      ayudatxt.place(x=10, y=425)
      ayudatxt = tkinter.Label(canvaAyuda, text="En caso de requerir soporte tecnico enviar un correo a cualquiera de estos dos: ------- y -------", font=("Cooper black", 12), bg="lightYellow", fg="black")  # Ayuda
